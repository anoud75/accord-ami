...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className={`fixed top-0 inset-x-0 z-50 bg-background border-b border-border transition-transform duration-300 ${showNav ? "translate-y-0" : "-translate-y-full"}`}>
      ...
      <section className="mx-auto max-w-5xl px-6 pt-6 pb-12">
        <div className="bg-neutral-100 rounded-2xl p-10 md:p-14 flex flex-col md:flex-row md:items-center gap-10 md:gap-0">
          ...
          <div className="flex-shrink-0 w-full md:w-[420px] mix-blend-multiply">
            <img
      ...
      {/* Section 2 — Feature blocks (Notion-style cards) */}
      ...
      <section className="mx-auto max-w-5xl px-6 py-24">
        ...
        <div className="mt-20 pt-6 border-t border-border flex items-center justify-between">
