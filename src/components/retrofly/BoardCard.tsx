...
const BoardCard = ({ response, isClosed, upvoteInfo }: BoardCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white border border-border/60 rounded-lg p-3 shadow-[0_1px_2px_rgba(0,0,0,0.04)] hover:shadow-[0_2px_6px_rgba(0,0,0,0.08)] transition-shadow duration-150 space-y-2 relative group"
    >
      {/* Header */}
